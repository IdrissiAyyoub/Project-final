...
document.addEventListener("DOMContentLoaded", () => {
    ...
    <p><strong>ISBN-10:</strong> ${bookInfo.industryIdentifiers ? bookInfo.industryIdentifiers[0].identifier : "N/A"}</p>
    <p><strong>ISBN-13:</strong> ${bookInfo.industryIdentifiers ? bookInfo.industryIdentifiers[1].identifier : "N/A"}</p>
    ...
    document.getElementById('modal-book-title').textContent = bookInfo.title;
    document.getElementById('modal-book-rating').textContent = `★ ${bookInfo.averageRating || 'No Rating'}`;
    document.getElementById('modal-book-genre').textContent = bookInfo.categories ? bookInfo.categories.join(", ") : "Unknown Genre";
    ...
    window.addEventListener('click', function (event) {
        ...
        console.log('Window click detected'); // Debugging
    modal.style.display = 'none';
        }
    });
});